...
<div class="row">
	<div class="col-xs-12">
		...
		<form class="form-horizontal" role="form" action="schoolnewup" method="post" enctype="multipart/form-data">
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
			<input type="hidden" name="id" value="{{$res['school_id']}}">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 学校名称： </label>

				<div class="col-sm-9">
					<input type="text" name="school_name" id="form-field-1" value="{{$res['school_name']}}" class="col-xs-10 col-sm-5" />
				</div>
			</div>
			<div class="space-4"></div>
            <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-6">校徽：</label>
			<div class="col-sm-9">
			<img src="{{$res['school_badge']}}" width="50px" ; height="80px" ; />
			<input type="file" id="id-input-file-2" name="school_badge"  />
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-tags">学校简介：</label>

				<div class="col-sm-9">
				<textarea id="form-field-11" name="school_desc" class="autosize-transition form-control">{{$res['school_desc']}}</textarea>							
				</div>
			</div>
