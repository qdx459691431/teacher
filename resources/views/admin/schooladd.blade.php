...
<div class="row">
	<div class="col-xs-12">
		...
		<form class="form-horizontal" role="form" action="schooladds" method="post" enctype="multipart/form-data">
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 学校名称： </label>

				<div class="col-sm-9">
					<input type="text" name="school_name" id="form-field-1" placeholder="学校名称" class="col-xs-10 col-sm-5" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
				<textarea id="form-field-11" name="school_desc" class="autosize-transition form-control"></textarea>							
				</div>
			</div>
