							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="jia" method='post'>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select name="courseid" class="col-xs-10 col-sm-5"  onchange="select_zhangjie(this.value)">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 目录名称</label>

										<div class="col-sm-9">
											<input type="text"   name='listname' class="col-xs-10 col-sm-5" />
