                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo $v['course_id']?>">{{$v['course_name']}}</a>
                                                </td>
                                                <td>{{$v['course_desc']}}</td>
                                                <td class="hidden-480">{{$v['school_name']}}</td>
                                                <td>{{$v['course_time']}}课时</td>

                                                <td class="hidden-480">
                                                    <span class="label label-sm label-warning">{{$v['teacher_name']}}</span>
                                                </td>
