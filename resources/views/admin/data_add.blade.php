...
<html lang="en">
	<head>
		...
		<![endif]-->
		<script type="text/javascript" charset="utf-8" src="admin/assets/ueditor.config.js"></script>
   		 <script type="text/javascript" charset="utf-8" src="admin/assets/ueditor.all.min.js"> </script>
	</head>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="ad" method='post'>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">目录名称</label>

										<div class="col-sm-9">
											<select name="listid" class="col-xs-10 col-sm-5"  >
												<option value='0'>请选择</option>
												@foreach($arr as $K=>$a)
													<option value="<?php echo $a['list_id']; ?>" >{{$a['list_name']}}</option>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">数据内容</label>
